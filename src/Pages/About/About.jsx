  ...
  return (
    <Layout>
      <div className="flex flex-wrap lg:flex-nowrap md:flex-nowrap gap-10 mx-4 lg:mx-20 md:mx-5 mt-10 font-inter">
        <div>
          <div className="max-w-[100%] lg:w-[350px] md:w-[350px] p-5 lg:mb-4 md:mb-4 border shadow-md dark:bg-[#1E1E1E] dark:border-none">
          ...
          <div className="hidden lg:block md:block w-[350px] p-5 lg:mt-4 md:mt-4 border shadow-md dark:bg-[#1E1E1E] dark:border-none">
            ...
            <p className="flex items-center gap-2 my-3 text-[#666f77]"> <PiEnvelopeSimpleLight className="text-[#4f46e5] dark:text-[#636ae8]" size={20}/> christofaokoro@gmail.com</p>
            <p className="flex items-center gap-2 my-3 text-[#666f77]"> <PiPhone className="text-[#4f46e5] dark:text-[#636ae8]" size={20} /> +(234) 8171-204-103</p>
            <p className="flex items-center gap-2 my-3 text-[#666f77]"> <SlLocationPin className="text-[#4f46e5] dark:text-[#636ae8]" size={20} /> Lagos, Nigeria</p>
            <div className="border-b w-70 mx-auto my-5"></div>
            <div className="flex items-center gap-3">
              <Button className="border border-[#4f46e5] p-3 w-10 text-[#4f46e5] dark:text-[#636ae8]"><SlSocialLinkedin /></Button>
              <Button className="border border-[#4f46e5] p-3 w-10 text-[#4f46e5] dark:text-[#636ae8]"><FiGithub /></Button>
              <Button className="border border-[#4f46e5] p-3 w-10 text-[#4f46e5] dark:text-[#636ae8]"><PiTwitterLogo/></Button>
            </div>
          </div>
        </div>
        <div>
