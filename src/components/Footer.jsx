    ...
    <div className="mx-4 lg:mx-20 md:mx-8 font-inter">
      <div className="flex flex-col justify-center items-center gap-2 py-4">
        ...
        <div className="flex items-center gap-2 mb-2">
          <InputGroup startElement={<RxEnvelopeClosed />} className="border-2 dark:border">
            <Input placeholder="Enter your email"/>
          </InputGroup>
          <Button className="bg-[#4f46e5] p-2 border-2-[#4f46e5] rounded text-white transition-all duration-200 hover:scale-105 hover:bg-[#4f46e5] hover:text-white active:scale-95">
            Subscribe
          </Button>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center text-[12px] lg:text-[16px] md:text-[16x] lg:pl-20 md:pl-20 lg:pr-65 md:pr-32">
        <div className="flex flex-col text-[10px] lg:text-[15px] md:text-[15px]">
          <Link className="font-mono text-[15px] lg:text-[18px] md:text-[18px] font-bold">Explore</Link>
        ...
        <div className="flex flex-col text-[10px] lg:text-[14px] md:text-[15px]">
          <h1 className="font-mono text-[15px] lg:text-[18px] md:text-[18px] font-bold">Services</h1>
          <p>Web Development</p>
          <p>UI/UX</p>
          <p>Tecnical Writing Me</p>
        </div>
        <div className="flex flex-col text-[10px] lg:text-[15px] md:text-[15px]">
          <h1 className="font-mono text-[14px] lg:text-[18px] md:text-[18px] font-bold">Resources</h1>
          <p>Blog</p>
          <p>Case Studies</p>
          <p>Articles</p>
        </div>
        <div className="flex flex-col text-[10px] lg:text-[14px] md:text-[15px]">
          <h1 className="font-mono text-[14px] lg:text-[18px] md:text-[18px] font-bold">Connect</h1>
          <p>LinkedIn</p>
          <p>GitHub</p>
          <p>Email</p>
        </div>
      ...
      <div className="flex justify-between items-center text-[12px] mt-3 mb-5 lg:mb-2 md:mb-2  lg:text-[16px] md:text-[16x] lg:px-32 md:px-10 lg:py-5 md:py-2">
        <div className=" rounded p-1 w-[55px] lg:w-20 md:w-20 text-center bg-[#4f46e5] text-white">English</div>
